...
# LHAPDF6 source files
# alplhapdf.f: real implementation (linked with gen-lhapdf)
# alplhapdf_stubs.f: stub routines (linked with gen, errors if ilhapdf=1)
LHAPDF_SRC= $(alp)/alplhapdf.f
LHAPDF_STUBS_SRC= $(alp)/alplhapdf_stubs.f
...
# LHAPDF object files
LHAPDF_OBJ=$(LHAPDF_SRC:.f=.o)
LHAPDF_STUBS_OBJ=$(LHAPDF_STUBS_SRC:.f=.o)
...
# fortran77 version (without LHAPDF)
gen: $(OBJ) $(LHAPDF_STUBS_OBJ)
	$(FFF) -o $(execfile) $(usrfile).o $(prcfile).o \
	$(alp)/alpgen.o $(alp)/alputi.o $(alp)/alppdf.o \
	$(alp)/alplhapdf_stubs.o \
	$(alp)/Acp.o $(alp)/Asu3.o $(alp)/Aint.o

# fortran77 version with LHAPDF6 support
# Usage: make gen-lhapdf prc=XXX LHAPDF=yes
gen-lhapdf: $(OBJ) $(LHAPDF_OBJ)
	$(FFF) -o $(execfile) $(usrfile).o $(prcfile).o \
	$(alp)/alpgen.o $(alp)/alputi.o $(alp)/alppdf.o \
	$(alp)/alplhapdf.o \
	$(alp)/Acp.o $(alp)/Asu3.o $(alp)/Aint.o \
...
cleanobj:
	-rm $(PARTON:.f=.o) $(PARTON90:.f90=.o) $(LHAPDF_OBJ) $(LHAPDF_STUBS_OBJ) $(prcusr)/../*/*.o90*

# remove object files, etc
cleanall:
	-rm $(OBJ) $(LHAPDF_OBJ) $(LHAPDF_STUBS_OBJ) $(prcusr)/fort.* $(prcusr)/*.top $(prcusr)/*.par \
